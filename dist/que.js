...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _init__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_init */ \"./src/methods/helpers/_init.js\");\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./_config */ \"./src/methods/helpers/_config.js\");\n/* harmony import */ var _query__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./_query */ \"./src/methods/helpers/_query.js\");\n/** ----------------------------------------\n    Utilities\n ---------------------------------------- */\n\n\n\n/** ----------------------------------------\n    Exports\n ---------------------------------------- */\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  _init: _init__WEBPACK_IMPORTED_MODULE_0__[\"default\"],\n  _setConfig: _config__WEBPACK_IMPORTED_MODULE_1__[\"default\"],\n  _setQuery: _query__WEBPACK_IMPORTED_MODULE_2__[\"default\"]\n});\n\n//# sourceURL=webpack://Que/./src/methods/helpers/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nfunction _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _nonIterableRest(); }\n\nfunction _nonIterableRest() { throw new TypeError(\"Invalid attempt to destructure non-iterable instance\"); }\n\nfunction _iterableToArrayLimit(arr, i) { if (!(Symbol.iterator in Object(arr) || Object.prototype.toString.call(arr) === \"[object Arguments]\")) { return; } var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i[\"return\"] != null) _i[\"return\"](); } finally { if (_d) throw _e; } } return _arr; }\n\nfunction _arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }\n\n/** ----------------------------------------\n    Add\n ---------------------------------------- */\nfunction add(obj) {\n  var _this = this;\n\n  var data = Object.entries(obj);\n\n  var duplicate = function duplicate(name, value) {\n    var data = _this.data[name];\n    _this.data[name] = !data ? [] : data;\n    return _this.config.duplicate && !_this.data[name].includes(value);\n  };\n\n  data.forEach(function (item) {\n    var _item = _slicedToArray(item, 2),\n        name = _item[0],\n        value = _item[1];\n\n    var isArray = Array.isArray(value);\n    var array = isArray ? value : value.split();\n    array.forEach(function (value) {\n      duplicate(name, value) && _this._data[name].push(value);\n    });\n  });\n\n  var uri = this._createUri();\n\n  this._updateUri(uri);\n}\n/** ----------------------------------------\n    Exports\n ---------------------------------------- */\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (add);\n\n//# sourceURL=webpack://Que/./src/methods/retrieve/_add.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _add__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_add */ \"./src/methods/retrieve/_add.js\");\n/* harmony import */ var _refresh__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./_refresh */ \"./src/methods/retrieve/_refresh.js\");\n/* harmony import */ var _remove__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./_remove */ \"./src/methods/retrieve/_remove.js\");\n/* harmony import */ var _set__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./_set */ \"./src/methods/retrieve/_set.js\");\n/* harmony import */ var _value__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./_value */ \"./src/methods/retrieve/_value.js\");\n/** ----------------------------------------\n    Utilities\n ---------------------------------------- */\n\n\n\n\n\n/** ----------------------------------------\n    Exports\n ---------------------------------------- */\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  add: _add__WEBPACK_IMPORTED_MODULE_0__[\"default\"],\n  refresh: _refresh__WEBPACK_IMPORTED_MODULE_1__[\"default\"],\n  remove: _remove__WEBPACK_IMPORTED_MODULE_2__[\"default\"],\n  set: _set__WEBPACK_IMPORTED_MODULE_3__[\"default\"],\n  value: _value__WEBPACK_IMPORTED_MODULE_4__[\"default\"]\n});\n\n//# sourceURL=webpack://Que/./src/methods/retrieve/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _util_isDate__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @util/_isDate */ \"./src/util/_isDate.js\");\nfunction _typeof(obj) { if (typeof Symbol === \"function\" && typeof Symbol.iterator === \"symbol\") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === \"function\" && obj.constructor === Symbol && obj !== Symbol.prototype ? \"symbol\" : typeof obj; }; } return _typeof(obj); }\n\n/** ----------------------------------------\n    Utilities\n ---------------------------------------- */\n\n/** ----------------------------------------\n    Is Type\n ---------------------------------------- */\n\nvar isType = function isType(value) {\n  return typeof value !== 'number' && !isNaN(Object(_util_isDate__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(value)) && 'date' || Array.isArray(value) && 'array' || _typeof(value);\n};\n/** ----------------------------------------\n    Exports\n ---------------------------------------- */\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (isType);\n\n//# sourceURL=webpack://Que/./src/util/_isType.js?");
